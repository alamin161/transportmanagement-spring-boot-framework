    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div id="create-new-brands" class="col-12"><!--  col-md-6 -->
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Create New Driver Infromation</h5>
                        <h6 class="card-subtitle text-muted">This table is for all driver information</h6>
                    </div>
                    <div class="card-body">
                        <form >
                            <fieldset>
                               ...
                               <%-- <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <button id="saveDriver" name="saveDriver" class="btn btn-primary">Save</button>
            ...
            <div id="existing-brands" class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Existing Driver Information</h5>
                        <h6 class="card-subtitle text-muted">This table is for all driver information</h6>
                    </div>
                    <div class="card-body">
