...
///////////////////////////////////////////////////////////////////////////////////
        ...
        $( "#btnPendingList" ).click(function() {
            ...
            $( "#divRequisitionApprovedList").hide();
            $( "#divRequisitionRejectedList").hide();
            $("#ex-requisition h5").html("Pending List For Approval");
        ...
        $( "#btnApprovedList" ).click(function() {
            ...
            $( "#divRequisitionRejectedList").hide();
            $("#ex-requisition h5").html("Approved List");
        ...
        $( "#btnRejectedList" ).click(function() {
            ...
            $("#ex-requisition h5").html("Rejected List");
...
<main class="content">
	<div class="container-fluid p-0">
		<div class="clearfix">
			<div id="divRequisitionHeading" class="float-right ">
				<a href="#" class="btn btn-primary" id ="btnPendingList"> Approval Waiting List</a>
    			<a href="#" class="btn btn-primary" id ="btnApprovedList"> Approved List</a>
    			<a href="#" class="btn btn-primary" id ="btnRejectedList"> Approval Rejected List</a>
			</div>
			<h1 class="h3 mb-3">Transport Requisitions Approval</h1>
		</div>	
		<div class="row">
			<div id="existing-requisition" class="col-12">
				<div class="card">
					<div id="ex-requisition" class="card-header">
						<h5 class="card-title">Pending List For Approval</h5>
						<h6 class="card-subtitle text-muted">This table is for all requisition information</h6>
					</div>
					<div class="card-body">
						<!-- pending list div -->
						<div  id="divRequisitionPendingList">
						...
						<!-- Approved  list div -->
						<div id="divRequisitionApprovedList">
						...
						<!-- Reject list div -->
						<div id="divRequisitionRejectedList">
