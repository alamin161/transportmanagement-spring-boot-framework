...
public class TransportRequisition {
	...
	public String toString() {
		return "TransportRequisition [id=" + id + ", tmpId=" + tmpId + ", fkRequestedBy=" + fkRequestedBy
				+ ", travelDate=" + travelDate + ", fkTransportType=" + fkTransportType + ", purpose=" + purpose
				+ ", status=" + status + ", tmpStatus=" + tmpStatus + ", comments=" + comments + "]";
	}
