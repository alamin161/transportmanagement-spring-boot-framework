...
public class ScheduledTravelInformation {
	...
	public String toString() {
		return "ScheduledTravelInformation [id=" + id + ", fkTrnsportId=" + fkTrnsportId + ", fkScheduleId="
				+ fkScheduleId + ", fkDriverId=" + fkDriverId + ", travelDate=" + travelDate + ", departureTime="
				+ departureTime + ", arrivalTime=" + arrivalTime + ", comments=" + comments + "]";
	}
